...
# Sweetviz Report erstellen
st.subheader("Data Profile Report")
report = sv.analyze(df)
# Report als HTML speichern
report.show_html(filepath='SWEETVIZ_REPORT.html', open_browser=False, layout='vertical', scale=None)

# HTML in Streamlit einbinden
with open('SWEETVIZ_REPORT.html', 'r', encoding='utf-8') as f:
    html_string = f.read()

components.html(html_string, width=1000, height=800, scrolling=True)
